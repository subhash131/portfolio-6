...
const ImmersiveExperience = () => {
  return (
    <Perspective3d
      className={`top-20 absolute text-xl text-center text-black left-[calc(24rem+5rem)] w-80 p-4 h-52 bg-[#C4BDA5] grid place-content-center rounded-md transition-all ${englebert.className}`}
    >
