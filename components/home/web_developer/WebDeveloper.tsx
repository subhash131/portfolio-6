...
const WebDeveloper = () => {
  return (
    <MotionPerspective3d
      ...
      className={`bottom-[5%] absolute text-3xl text-center text-white left-[4%] h-[55%] w-[30%]  bg-[#7B896B] grid place-content-center rounded-md ${englebert.className} transition-all`}
    >
      <MotionPerspective3d
        initial={{
          height: 0,
